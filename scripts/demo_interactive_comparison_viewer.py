...
from oram_sim.viewer import parse_viewer_command, viewer_help_text
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Interactive NaiveStorage vs PathORAM comparison viewer.",
    )
    ...
    parser.add_argument(
        "--show-values",
        action="store_true",
        help="Show stored values in the Path ORAM tree and stash.",
    )
...
def render_screen(
    ...
    console.print()
    console.print(rich_comparison_frame(frame, show_values=show_values))
    console.print()
    console.print(
